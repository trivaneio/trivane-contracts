...
# Generate new bindings
	@forge bind --root $(CONTRACTS_PATH) --crate-name trivane-contracts
...
# Target for running all commands in sequence
all: setup bindings build test fmt
	@echo "All tasks completed successfully!"

# Declare phony targets
.PHONY: build build-release clean fmt bindings all test-contracts
