...
```*/
    ...
    ///Container for all the [`SuperchainERC20`](self) function calls.
    pub enum SuperchainERC20Calls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for SuperchainERC20Calls {
        const NAME: &'static str = "SuperchainERC20Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<SuperchainERC20Calls>] = &[
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                ...
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::approve)
                    }
                    approve
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn crosschainMint(
                        ...
                        <crosschainMintCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::crosschainMint)
                    }
                    crosschainMint
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn crosschainBurn(
                        ...
                        <crosschainBurnCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::crosschainBurn)
                    }
                    crosschainBurn
                },
                {
                    fn decimals(
                        ...
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::decimals)
                    }
                    decimals
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                    fn version(
                        ...
                        <versionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::version)
                    }
                    version
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn nonces(
                        ...
                        <noncesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::nonces)
                    }
                    nonces
                },
                {
                    fn symbol(
                        ...
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::symbol)
                    }
                    symbol
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::transfer)
                    }
                    transfer
                },
                {
                    fn permit(
                        ...
                        <permitCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::permit)
                    }
                    permit
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Calls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`SuperchainERC20`](self) custom errors.
    pub enum SuperchainERC20Errors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for SuperchainERC20Errors {
        const NAME: &'static str = "SuperchainERC20Errors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<SuperchainERC20Errors>] = &[
                {
                    fn InsufficientAllowance(
                        ...
                        <InsufficientAllowance as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::InsufficientAllowance)
                    }
                ...
                },
                {
                    fn PermitExpired(
                        ...
                        <PermitExpired as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::PermitExpired)
                    }
                    PermitExpired
                },
                {
                    fn Permit2AllowanceIsFixedAtInfinity(
                        ...
                        <Permit2AllowanceIsFixedAtInfinity as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                SuperchainERC20Errors::Permit2AllowanceIsFixedAtInfinity,
                            )
                    }
                ...
                },
                {
                    fn Unauthorized(
                        ...
                        <Unauthorized as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::Unauthorized)
                    }
                    Unauthorized
                },
                {
                    fn AllowanceUnderflow(
                        ...
                        <AllowanceUnderflow as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::AllowanceUnderflow)
                    }
                    AllowanceUnderflow
                },
                {
                    fn InvalidPermit(
                        ...
                        <InvalidPermit as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::InvalidPermit)
                    }
                    InvalidPermit
                },
                {
                    fn TotalSupplyOverflow(
                        ...
                        <TotalSupplyOverflow as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::TotalSupplyOverflow)
                    }
                    TotalSupplyOverflow
                },
                {
                    fn InsufficientBalance(
                        ...
                        <InsufficientBalance as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::InsufficientBalance)
                    }
                    InsufficientBalance
                },
                {
                    fn AllowanceOverflow(
                        ...
                        <AllowanceOverflow as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SuperchainERC20Errors::AllowanceOverflow)
                    }
                    AllowanceOverflow
                },
            ];
    ...
    ///Container for all the [`SuperchainERC20`](self) events.
    pub enum SuperchainERC20Events {
        #[allow(missing_docs)]
        Approval(Approval),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for SuperchainERC20Events {
        const NAME: &'static str = "SuperchainERC20Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for SuperchainERC20Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`SuperchainERC20`](self) contract instance.

See the [wrapper's documentation](`SuperchainERC20Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> SuperchainERC20Instance<T, P, N> {
        SuperchainERC20Instance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<SuperchainERC20Instance<T, P, N>>,
    > {
        SuperchainERC20Instance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        SuperchainERC20Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`SuperchainERC20`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`SuperchainERC20`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct SuperchainERC20Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for SuperchainERC20Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("SuperchainERC20Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<SuperchainERC20Instance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> SuperchainERC20Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> SuperchainERC20Instance<T, P, N> {
